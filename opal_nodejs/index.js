...
/* Generated by Opal 0.10.3 */
(function(Opal) {
  var $a, TMP_1, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $hash2 = Opal.hash2, server = nil;

  Opal.add_stubs(['$call', '$lambda']);
  var http = require('http');
  server = ($a = (TMP_1 = function(req, res){var self = TMP_1.$$s || this, $b, $c, TMP_2, $d, TMP_3, req_on = nil;
if (req == null) req = nil;if (res == null) res = nil;
  req_on = req["on"].bind(req);
    req_on.$call("data", ($b = ($c = self).$lambda, $b.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

    return nil}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $b).call($c));
    return req_on.$call("end", ($b = ($d = self).$lambda, $b.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

    res.writeHead(200, $hash2(["content-type", "content-length"], {"content-type": "text/plain", "content-length": 4}));
      return res.end("pong");}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $b).call($d));}, TMP_1.$$s = self, TMP_1.$$arity = 2, TMP_1), (http).createServer)($a);
